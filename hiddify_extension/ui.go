...
func (e *Ext) setFormData(data map[string]string) error {
...
func (e *Ext) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "ext",
		Description: "Awesome Extension ext created by d4rkr4in",
		Fields: [][]ui.FormField{
			{{
...
func (e *Ext) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "ext",
		Description: "Awesome Extension ext created by d4rkr4in",
...
func (e *Ext) addAndUpdateConsole(message ...any) {
